...
public class SimpleDictReader implements FileDictReader{
	...
	public static void main(String[] args) {
		...
		SimpleDictReader aFileDictReader=new SimpleDictReader();
		MemDict aMemDict=new MemDict();
		
		try {
			aFileDictReader.addDictFile("Dic/combined.dic");
		} catch (IOException e) {
